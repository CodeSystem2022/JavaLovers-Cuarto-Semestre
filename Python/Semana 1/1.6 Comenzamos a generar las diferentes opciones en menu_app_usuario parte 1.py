...
while opcion != 5:
    ...
    if opcion == 1:
        ...
        password_var = input('Digite su clave: ')
        ...
        password_var = input('Digite la clave del usuario a modificar: ')
        ...
        log.info(f'Usuario eliminado: {usuario_eleminado}')
else:
    log.info('Salimos de la aplicaion,hasta pronto')
